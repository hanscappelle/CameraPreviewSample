package net.pikanji.camerapreviewsample.zxing.camera;
...
public class CameraConfigurationManager {
    ...
    public void setDesiredCameraParameters(Camera camera) {
        ...
        // always safe mode from now on
        Log.w(TAG, "In camera config safe mode -- most settings will not be honored");

        // initializeTorch(parameters, prefs, safeMode);
        setBestPreviewFPS(parameters);

        // this is the preferred way, only try other settings if this fails
        ...
        // at this point we should have something to set
        if (focusMode != null) {
